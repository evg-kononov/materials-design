...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt_path", type=str, default="./chekpoint", help="Path to the checkpoints to resume training")
    parser.add_argument("--local_rank", type=int, default=0, help="Local rank for distributed training")
    parser.add_argument("--log_resolution", type=int, default=6, help="The log2 of image resolution")
    parser.add_argument("--d_latent", type=int, default=512, help="The size of the latent space")
    parser.add_argument("--n_layers", type=int, default=8, help="Number of layers in the mapping network")
    ...
    parser.add_argument("--WGAN_GP", action="store_false", help="Whether to use the WGAN-GP")
    ...
    parser.add_argument("--activation", action="store_true", help="Generator output activation")
    parser.add_argument("--lr", type=float, default=0.002, help="Learning rate")
    parser.add_argument("--calc_fid", action="store_true", help="Whether to calculate FID")
    ...
    if get_rank() == 0 and wandb is not None and args.use_wandb:
        config = dict(
            ...
            loss='R1+PL' if args.WGAN_GP is False else 'WGAN_GP',
